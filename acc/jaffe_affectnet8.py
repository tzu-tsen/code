...
import dataset.Jaffe as Dataset
from package import resnet_cbam, model1

import package.confusion_matrix as ConfusionMatrix
import package.parameter_jaffe as parameter
import package.fun_ensemble_jaffe as fun
...
val_figure_cm = ConfusionMatrix.figure_confusion_matrix(
    val_target_lists, val_predict_lists, p.class_names)
